...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { content: @visitor.content, email: @visitor.email, name: @visitor.name, telephone: @visitor.telephone }
    end
  ...
  test "should update visitor" do
    patch :update, id: @visitor, visitor: { content: @visitor.content, email: @visitor.email, name: @visitor.name, telephone: @visitor.telephone }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
